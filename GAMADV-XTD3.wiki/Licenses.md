...
| Google Workspace Business Starter | 1010020027 | wsbizstart |
...
| Google Workspace Frontline | 1010020030 | workspacefrontline | workspacefrontlineworker |
...
| Google Workspace for Edutation: Teaching and Learning Upgrade | 1010370001 | gwetlu |
...
gam <UserTypeEntity> sync license <SKUID> [product|productid <ProductID>]
        [addonly|removeonly] [preview] [actioncsv]
```
