...
csv_output_quote_char
        ...
        to a single quote, the output is much cleaner.
        Default: '"'
...
enable_dasa
        ...
        Will be used in the future to make all GAMADV-XTD3 API access via a service account
        This is for non-production testing only!
...
tls_max_version
        Allowed values: '', tlsv1, tlsv1_0, tlsv1.0, tlsv1_1, tlsv1.1, tlsv1_2, tlsv1.2, tlsv1_3, tlsv1.3
...
redirected to a file before the csv command.
```
$gam redirect csv FilesDomainAdmins.csv multiprocess csv  InfoDomains.csv gam select ~Section user "~AdminUser" show filelist id
```
...
the csv command.
```
$gam csv InfoDomains.csv select ~Section redirect csv Files-~~Domain~~-Admin.csv user "~AdminUser" show filelist id
```
