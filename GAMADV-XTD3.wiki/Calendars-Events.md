...
```
gam calendar <CalendarEntity> show events [<EventSelectEntity>] <EventDisplayProperty>*
        [fields <EventFieldNameList>] [showdayofweek]
...
```
gam calendar <CalendarEntity> print events [<EventSelectEntity>] <EventDisplayProperty>*
         [fields <EventFieldNameList>] [showdayofweek]
