...
```
<CSVkmdSelector> ::=
        csvkmd (<FileName>|(gsheet <UserGoogleSheet>)
...
<EventIDEntity> ::=
        <EventIDList> | <FileSelector> | <CSVFileSelector> | <CSVkmdSelector> | <CSVDataSelector>
<GroupEntity> ::=
...
<OtherContactResourceNameEntity> ::=
        <OtherContactResourceNameNameList> | <FileSelector> | <CSVFileSelector> | <CSVDataSelector>
