...
- [Google Workspace SMTP relay service](#g-suite-smtp-relay-service)
- [Send an email](#send-an-email)
- [Send an email from a group](#send-an-email-from-a-group)
- [Send an email to notify a person of their new GSuite account](#send-an-email-to-notify-a-person-of-their-new-gsuite-account)
...
Configure it at Admin Console/Apps/Google Workspace/Gmail/Advanced settings/Routing/SMTP relay service/ADD ANOTHER
* Give the service a name, e.g., "GAM SMTP"
* `1. Allowed senders` - `Only addresses in my domain`
* `2. Authentication`
...
## Send an email to notify a person of their new GSuite account
