...
```
gam redirect csv ./SharedDriveNamesIDs.csv multiprocess [todrive <ToDriveAttribute>*] csv SharedDriveNames.csv gam user "~User" create teamdrive "~name" csv [other options as desired]
```
...
gam <UserTypeEntity> show teamdriveacls
        ...
        [formatjson [quotechar <Character>]] adminaccess
