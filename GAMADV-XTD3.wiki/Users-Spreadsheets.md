...
When `formatjson` is used with `print`, `"` is used to enclose data items in the values column; with the default `csv_output_quote_char = '"'`, all of the `"` in the data are doubled.
