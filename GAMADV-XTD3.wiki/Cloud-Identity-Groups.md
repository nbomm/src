...
gam update cigroup <GroupEntity> [copyfrom <GroupItem>] <GroupAttribute>
        [makesecuritygroup|security] [dynamic <QueryDynamicGroup>]
...
gam print cigroups [todrive <ToDriveAttribute>*]
        [(cimember|showownedby <UserItem>)|(select <GroupEntity>)]
...
* `allfields|ciallfields` - All Cloud Identity Group fields are displayed
