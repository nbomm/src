...
[*]  2)  Chrome Management API - read only
[*]  3)  Chrome Policy API (supports readonly)
[*]  4)  Chrome Printer Management API (supports readonly)
[*]  5)  Chrome Version History API
[*]  6)  Classroom API - Course Announcements (supports readonly)
[*]  7)  Classroom API - Course Topics (supports readonly)
[*]  8)  Classroom API - Course Work/Materials (supports readonly)
[*]  9)  Classroom API - Course Work/Submissions (supports readonly)
[*] 10)  Classroom API - Courses (supports readonly)
[*] 11)  Classroom API - Profile Emails
[*] 12)  Classroom API - Profile Photos
[*] 13)  Classroom API - Rosters (supports readonly)
[*] 14)  Classroom API - Student Guardians (supports readonly)
[*] 15)  Cloud Identity Groups API (supports readonly)
[*] 16)  Cloud Storage (Vault Export - read only)
[*] 17)  Contact Delegation API (supports readonly)
[*] 18)  Contacts API - Domain Shared and Users and GAL
[*] 19)  Data Transfer API (supports readonly)
[*] 20)  Directory API - Chrome OS Devices (supports readonly)
[*] 21)  Directory API - Customers (supports readonly)
[*] 22)  Directory API - Domains (supports readonly)
[*] 23)  Directory API - Groups (supports readonly)
[*] 24)  Directory API - Mobile Devices Directory (supports readonly and action)
[*] 25)  Directory API - Organizational Units (supports readonly)
[*] 26)  Directory API - Resource Calendars (supports readonly)
[*] 27)  Directory API - Roles (supports readonly)
[*] 28)  Directory API - User Schemas (supports readonly)
[*] 29)  Directory API - User Security
[*] 30)  Directory API - Users (supports readonly)
[*] 31)  Groups Migration API
[*] 32)  Groups Settings API
[*] 33)  License Manager API
[*] 34)  People API (supports readonly)
[*] 35)  People Directory API - read only
[ ] 36)  Pub / Sub API
[*] 37)  Reports API - Audit Reports
[*] 38)  Reports API - Usage Reports
[ ] 39)  Reseller API
[*] 40)  Site Verification API
[*] 41)  Sites API
[*] 42)  Vault API (supports readonly)
...
Domain-Wide Delegation authentication:, User: user@domain.com, Scopes: 20
  ...
  https://www.googleapis.com/auth/activity                                  PASS (4/20)
  https://www.googleapis.com/auth/apps.alerts                               PASS (5/20)
  https://www.googleapis.com/auth/calendar                                  PASS (6/20)
  https://www.googleapis.com/auth/classroom.announcements                   PASS (7/20)
  https://www.googleapis.com/auth/classroom.coursework.students             PASS (8/20)
  https://www.googleapis.com/auth/classroom.profile.emails                  PASS (9/20)
  https://www.googleapis.com/auth/classroom.rosters                         PASS (10/20)
  https://www.googleapis.com/auth/classroom.topics                          PASS (11/20)
  https://www.googleapis.com/auth/cloudprint                                PASS (12/20)
  https://www.googleapis.com/auth/contacts                                  PASS (13/20)
  https://www.googleapis.com/auth/drive                                     PASS (14/20)
  https://www.googleapis.com/auth/drive.activity                            PASS (15/20)
  https://www.googleapis.com/auth/gmail.modify                              PASS (16/20)
  https://www.googleapis.com/auth/gmail.settings.basic                      PASS (17/20)
  https://www.googleapis.com/auth/gmail.settings.sharing                    PASS (18/20)
  https://www.googleapis.com/auth/iam                                       FAIL (19/20)
...
Domain-Wide Delegation authentication:, User: user@domain.com, Scopes: 20
  ...
  https://www.googleapis.com/auth/gmail.settings.basic                      PASS (17/20)
  https://www.googleapis.com/auth/gmail.settings.sharing                    PASS (18/20)
  https://www.googleapis.com/auth/iam                                       PASS (19/20)
  https://www.googleapis.com/auth/spreadsheets                              PASS (20/20)
All scopes PASSED!
